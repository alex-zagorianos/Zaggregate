...
| [[handoff_20260701_session27]]                          | **Latest session** — live eval (Dad vs controls) + 2 fixes: concurrency pin, Dad-inbox supply fix (seed local Workday health systems, 19→23). See `brain\eval-2026-07-01-dad-vs-controls-runs.md`. |
