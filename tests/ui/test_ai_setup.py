...
def test_apply_setup_can_skip_onboarded(isolated):
    ...
    # S36b: apply_setup stamps a .wizard-in-progress sentinel in this case,
    # which suppresses is_onboarded's keyword inference until the wizard
    # actually finishes — the original contract holds.
    assert setup_wizard.is_onboarded() is False
